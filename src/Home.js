     ...
     <main>         
       ...
       <section id="projects">
          ...
          <div class="row container-projects">
            <div class="col-lg-3 "><div class="project1 project project-container1"></div><p class="project-text p-text-1">DDDD</p> </div>
            <div class="col-lg-3 "><div class="project2 project project-container2"></div><p class="project-text p-text-2">DDDD</p></div>
